...
%%
\newML{Title}{Searching for combinatorial covers using integer linear programming}{Þakningar fléttufræðilegra fyrirbrigða með aðstoð línulegrar heiltölubestunar}
\newML{TITLE}{SEARCHING FOR COMBINATORIAL COVERS USING INTEGER LINEAR PROGRAMMING}{ÞAKNINGAR FLÉTTUFRÆÐILEGRA FYRIRBRIGÐA MEÐ AÐSTOÐ LÍNULEGRAR HEILTÖLUBESTUNAR}
%%
...
\include{01-introduction}%%RUM: Introduction
\include{02-words}
\include{03-mesh-tilings}
\include{04-discussion}%%RUM: "Discussion"
